...
Chassis chassis(
    ...
    mik::motor_group({
		...
		mik::motor(PORT1, true, blue_6_1, "left_back_motor")
    }),
    mik::motor_group({
		mik::motor(PORT16, false, blue_6_1, "right_front_motor"), 
		mik::motor(PORT10, false, blue_6_1, "right_middle_motor"), 
    ...
    mik::distance_reset({
		...
		mik::distance(PORT5, rear_sensor, 5, 3.5)
    })
);

Assembly assembly(
	mik::motor_group({
		mik::motor(PORT19, false, green_18_1, "angle_changer_motor")
	}),

	mik::motor(PORT11, false, blue_6_1, "intake_motor"),
	vex::rotation(PORT12),
	mik::piston(PORT_B)
);
